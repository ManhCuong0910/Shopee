      ...
      return (
        purchasesInCart?.map((purchase) => {
          ...
          return {
            ...purchase,
            disabled: false,
            checked: Boolean(extendedPurchasesObject[purchase._id]?.checked) || isChoosePurchaseIdFromLocation
          }
        }) || []
      )
    })
  ...
  return (
    <div className='bg-neutral-100 py-16'>
      <Helmet>
        ...
        <meta name='description' content='Giỏ hàng Shopee clone'></meta>
      </Helmet>
        ...
        {extendedPurchases.length > 0 ? (
          ...
          <>
            <div className='text-center'>
              ...
              <div className='text-gray-4f00 mt-5 font-bold'>Giỏ hàng của bạn còn trống</div>
